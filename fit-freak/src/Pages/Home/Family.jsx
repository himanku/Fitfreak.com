...
const Family = () => {
    ...
    return (
        <Box className={styles.family}>
            <Box>
                <Text className={styles.family_text} fontSize={{base:"40px", md:"50px", lg: "70px"}}>Join the cult family</Text>
            </Box>
            <SimpleGrid mt="50px" columns={{base:"1", lg:"2", md:"2"}} spacing={10}>
                <Box className={styles.background1} width={{base:"450px", md:"350px", lg:"460px"}} height={{base:"300px", md:"250px", lg:"310px"}} borderRadius="20px" padding={4}>
                ...
                <Box  className={styles.background2} width={{base:"450px", md:"350px", lg:"460px"}} height={{base:"300px", md:"250px", lg:"310px"}} borderRadius="20px" padding={4}>
